                    ...
                    @endif
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group" id="currentImage">
                                ...
                                <img src="{!! asset('images/service/'.$data['image'])  !!}" class="current_image_detail img-responsive" idHinh="{!! $data['id'] !!}" id="{!! $data['id'] !!}" />
                                <a href="javascript:void(0)" type="button" id="delImageService" class="btn btn-danger btn-circle icon_del"><i class="fa fa-times"></i></a>
                            </div>
