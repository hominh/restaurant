                        ...
                        <div class="post post-single">
                            ...
                            <div class="post-body">
                                ...
                                <div class="post-title">
                                    <h3 class="xmd"><a href="{!! URL('post',[$item->palias]) !!}.html">{!! $item->pname !!}</a></h3>
                                </div>
                                <div class="post-content">
                                    <p>{!! $item->description !!}</p>
                                </div>
                                <div class="post-footer">
                                    <a href="{!! URL('post',[$item->palias]) !!}.html" class="awe-btn awe-btn-2 awe-btn-default text-uppercase">Read</a>
                                </div>
                            </div>
                        </div>
                    @endforeach()
